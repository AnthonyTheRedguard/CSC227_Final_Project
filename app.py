...
def display_menu():
    while True:
        ...
        try:
            ...
            print("14. Go home")
            choice = int(input("What is your course of action? "))
            print("\n")
        except ValueError:
...
def bonus_soda(sodas, encumbrance):
    bonus = randint(1, 25)
    if bonus == 14:
        print("Bonus Soda!!!\n")
        sodas += 1
    ...
    while True:
        ...
        if choice == 10:
            ...
            if cashback == 1:
                ...
                wallet += 1.00
            elif cashback not in [1, 2, 25, 100] and failed_attempts < 20:
                print("Ouch\n")
                failed_attempts += 1
            ...
            if encumbrance > 25:
                print("You're carrying over 25lbs of soda. Have fun walking home.\n")
                if failed_attempts > 20:
                    print("Your broken toe makes the walk even more fun.\n")
                break
            elif sodas >= 5 and encumbrance <= 25:
